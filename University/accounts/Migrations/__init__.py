...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('auth', '0012_alter_user_first_name_max_lenght'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.CharField(choices=[('ad', 'Administration'), ('fi', 'Finance'), ('se', 'Secretary'), ('te', 'Teacher'), ('pa', 'Parents'), ('st', 'Student')], max_length=2, verbose_name='Departament')),
